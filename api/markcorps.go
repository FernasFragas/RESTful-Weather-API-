...
func (api *MarkcorpsAPI) FetchReportData(ctx context.Context, city ...string) (*weatherservice.DataToReport[weatherservice.Hotels], error) {
	...
	hotels := make(weatherservice.Hotels, len(location))
...
func (api *MarkcorpsAPI) FetchGeneralInfo(ctx context.Context, city string) (*weatherservice.DataToReport[weatherservice.Hotels], error) {
	if api.client == nil {
		return nil, fmt.Errorf("client not initialized")
	}
	return nil, nil
